...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    title: 'A Machine-Checkable Theory of Change for Victim & Witness Support',
    category: 'open-demo',
    challenge: 'The Ministry of Justice funds the National Witness Service and National Homicide Service at scale, yet neither has been formally evaluated for some time. Before an impact evaluation is possible, each service needs a clear Theory of Change, a rapid evidence assessment and a feasibility-and-M&E framework to Magenta Book and Government Social Research standards. The hard part is being honest and systematic about which causal links the evidence actually supports, and making those judgements auditable.',
    intervention: 'A self-initiated, open, machine-readable demonstrator that builds the Theory of Change as a typed causal graph: 7 worked pathways across the two services, each resolving input to activity to output to outcome to impact, with every outcome anchored to one of the four Victims\' Funding Strategy national outcomes and every causal claim carrying an evidence grade. A structured rapid-evidence-assessment extraction schema (population, service model, delivery mode, outcome, effect, quality grade, provenance) makes the evidence map queryable. Aligned to the MoJ Areas of Research Interest 2025 interest in AI-assisted evidence synthesis.',
    assurance: 'Open and reproducible on GitHub under CC-BY-4.0. SHACL shapes validate completeness, outcome-to-VFS alignment, a mandatory evidence grade on every claim and declared assumptions; the graph conforms at zero violations, and the validator then surfaces two genuine evidence gaps (in-court attendance effect; homicide outreach for children and young people) rather than papering over them.',
    outcome: 'A method that turns "highlight the evidence gaps" from a hopeful instruction into a mechanical result: the deliverables a commissioner sees are the standard Theory of Change diagram, narrative and M&E framework, while the structured graph underneath makes them auditable, consistent across parallel service strands, and reusable in the full evaluation that follows.',
    reusable: 'The typed Theory-of-Change vocabulary, SHACL shapes and REA extraction schema transfer to any programme evaluation that must build a Theory of Change, grade its evidence and name its gaps under Magenta Book and GSR standards.',
  },
];
