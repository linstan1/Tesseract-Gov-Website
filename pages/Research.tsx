      ...
      <section className="bg-gov-bg border border-gov-border/50 p-10 rounded-xl">
        ...
        <ul className="space-y-8">
           <li className="pb-8 border-b border-gov-border/50 last:border-0 last:pb-0">
             <a href="/papers/aes-heritage-cobenefits-scoping-protocol.pdf" target="_blank" rel="noopener noreferrer"><h3 className="font-semibold text-lg text-gov-blue mb-2 hover:text-gov-blue-dark hover:underline transition-colors">Co-Benefits of Agri-Environment Heritage Actions: A Scoping Review Protocol<span className="sr-only"> (opens in new tab)</span></h3></a>
             <p className="text-sm text-gov-secondary/80 mb-3 font-medium">Open methods note, 2026</p>
             <p className="text-base text-gov-dark/90 leading-relaxed">A pre-registered, openly published protocol for establishing a baseline of evidence on the wider value of agri-environment scheme heritage actions, for the natural environment and for people. It sets out a scoping-review method built on recognised standards (PRISMA-ScR, the Collaboration for Environmental Evidence guidelines, and Natural England's own evidence-review approach), with a charting framework linking each heritage action to its co-benefits, Environmental Improvement Plan targets, and indicative value for money via the HM Treasury Green Book and a natural-capital approach.</p>
             <a href="/papers/aes-heritage-cobenefits-scoping-protocol.pdf" target="_blank" rel="noopener noreferrer" className="inline-block mt-3 text-sm font-medium text-gov-blue hover:text-gov-blue-dark hover:underline transition-colors">Read the protocol (PDF)<span className="sr-only"> (opens in new tab)</span></a>
           </li>
           <li className="pb-8 border-b border-gov-border/50 last:border-0 last:pb-0">
