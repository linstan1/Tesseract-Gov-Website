    ...
    <div className="max-w-6xl mx-auto px-6 lg:px-8 py-20 space-y-16">
      ...
      <section className="bg-gov-bg border border-gov-border/50 p-6 sm:p-10 rounded-xl">
        ...
        <PublicationGroup title="Register assurance" count={2}>
           <li className="pb-8 border-b border-gov-border/50 last:border-0 last:pb-0">
             <Link to="/research/securities-register-ontology"><h3 className="font-semibold text-lg text-gov-blue mb-2 hover:text-gov-blue-dark hover:underline transition-colors">Forty-Five Days Before the LEI Becomes the US Entity Standard, the SEC&apos;s Register of 981,355 Entities Lists 773</h3></Link>
             <p className="text-sm text-gov-secondary/80 mb-3 font-medium">Open ontology, four-register measurement, 2026</p>
             <p className="text-base text-gov-dark/90 leading-relaxed">On 1 October 2026 the joint data standards rule under the Financial Data Transparency Act makes the ISO 17442 Legal Entity Identifier the common entity standard for nine federal financial agencies, the SEC among them. We downloaded the SEC&apos;s entire entity register and every open register that embeds or is embedded by it, all on 17 August 2026. The lei field the register carries on every one of its 981,355 records is populated in 773 of them, and only 667 of those are valid LEIs: the remainder includes telephone numbers, IRS employer identification numbers, entity names typed into the identifier field and thirty-five literal &quot;N/A&quot; strings. In a single quarter 1,973 fund registrants stated their LEI to the SEC on Forms N-PORT and N-CEN, and the entity register surfaces 12 of them, while for CIK 892538 it carries the investment adviser&apos;s identity on the fund, the same defect class found at the FDIC a week earlier. GLEIF publishes the reverse crosswalk for 27,704 EDGAR-registered LEIs daily under CC0; the SEC publishes no mapping in either direction. Reconciling the two halves across 12,604 fund series finds 100 carrying two different LEIs on the two sides of the register boundary, including a checksum-failing character substitution and three ETF series holding each other&apos;s LEIs in a cycle, and 56.6 per cent of all US LEI records are LAPSED. An open OWL 2 ontology, SKOS scheme registry and SHACL governance layer, 525,387 triples, every headline computed two independent ways, reproducible from public data.</p>
             <div className="mt-3 flex flex-wrap gap-3 items-center">
