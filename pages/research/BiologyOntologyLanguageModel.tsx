...
const BUILD = [
  ...
  { item: 'Real, verified entities', detail: 'Identifiers drawn from real OBO releases — GO (38,245), MONDO (32,095), HP (19,836), ChEBI (218,253), Cell Ontology (3,335) — and gene/protein IDs verified against mygene.info. No invented CURIEs enter the data.' },
