    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="h-full flex flex-col group">
          ...
          <h3 className="text-lg font-semibold text-gov-dark mb-3">Policy-Aligned Advisory</h3>
        ...
        <Card className="h-full flex flex-col group">
          ...
          <h3 className="text-lg font-semibold text-gov-dark mb-3">Rapid Delivery</h3>
        ...
        <Card className="h-full flex flex-col group">
          ...
          <h3 className="text-lg font-semibold text-gov-dark mb-3">Data & AI Upskilling</h3>
          <p className="text-gov-secondary/90 mb-5 flex-grow leading-relaxed">
