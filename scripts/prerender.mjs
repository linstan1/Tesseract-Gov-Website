...
const PAGE_META = {
  ...
  '/research/insurance-register-ontology': {
    title: 'One in five of Europe’s insurers has no LEI in the EU’s own register: the EEA insurance fabric as a governance graph | Tesseract Academy for the Public Sector',
    description: 'An open OWL 2 ontology, SKOS registries and SHACL governance layer built against the entire EIOPA Register of Insurance Undertakings (33,924 rows) joined with a same-day GLEIF harvest of all 3,630 LEIs the register files. 643 of 3,304 active domestic (re)insurers (19.5%) carry no LEI; 4 filed LEI values are arithmetically impossible, including a letter-O-for-zero transposition; 118 active insurers’ LEIs have lapsed and 42 point at entities GLEIF says have ceased; one LEI is filed for both SCOR Global Reinsurance France and SCOR Global Reinsurance Ireland; 283 passports outlive their authorization. 276,683 triples, mapped against the 2026 crop of insurance ontologist job advertisements.',
  },
