...
const OntologyEngineering = lazy(() => import('./pages/services/OntologyEngineering').then(m => ({ default: m.OntologyEngineering })));
...
const PAGE_META: Record<string, { title: string; description: string }> = {
  ...
  '/research/enterprise-knowledge-ontology': {
    title: 'Enterprise knowledge graph ontology: your search index and your AI pipeline read different corpora | Tesseract Academy for the Public Sector',
